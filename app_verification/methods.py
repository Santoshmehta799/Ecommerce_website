...
def gst_excel_verification_step(company_gst_number, user):
    # print('=====================>>> GST Verification start here if selected')
    status = True
    msg = 'Pending Gst Verification'
    # redirect = '/account/gstindetail/'
...
def pan_excel_verification_step(company_pan_number, user):
    print('PAN Verification start here if selected')
    status = True
    message = 'Pending Pan Verification'
    user = user
...
def cin_excel_verification_step(company_cin_number, user):
...
def bank_excel_details_verification(account_holder_name, account_number, ifsc, user):
    status = True 
    message = 'Pending Bank Verification'
    user = user
    try:
