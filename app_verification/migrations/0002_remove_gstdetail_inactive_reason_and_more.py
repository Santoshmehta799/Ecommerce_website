...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(max_length=15, unique=True, validators=[django.core.validators.RegexValidator(message='Invalid GST Number.', regex='^[0-9][1-9][A-Z]{3}[PCHABGJLFT][A-Z][0-9]{4}[A-Z][0-9][Z][a-zA-Z0-9]$')]),
        ),
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('representative_name', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('user', models.OneToOneField(blank=True, default=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='user_representative_detail', to=settings.AUTH_USER_MODEL)),
            ],
            options={
