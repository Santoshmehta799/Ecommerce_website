    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('iso2_code', models.CharField(blank=True, max_length=10, null=True)),
                ('iso3_code', models.CharField(blank=True, max_length=10, null=True)),
                ('is_active', models.BooleanField(default=True)),
            ],
            options={
                'verbose_name': 'Dashboard - Country Details',
                'verbose_name_plural': 'Dashboard - Country Details',
            },
        ),
        migrations.CreateModel(
            name='States',
